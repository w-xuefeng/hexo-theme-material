...
$(document).ready(function () {
  ...
  $('a.toTop').click(function () {
    $('html, body').animate(
      {
        scrollTop: $(decodeURIComponent($(this).attr('href'))).offset().top + 'px',
      },
      {
        duration: 500,
        easing: 'swing',
...
var componentHandler = (function () {
  ...
  function a(e) {
    ...
    for (var t, s = 0, i = e.length; i > s; s++)
      (t = e[s]), t instanceof HTMLElement && (t.children.length > 0 && a(t.children), n(t));
  }
...
window.addEventListener('load', function () {
  ...
  (MaterialMenu.prototype.init = function () {
    ...
    if (this.element_) {
      ...
      for (var n = this.element_.querySelectorAll('.' + this.CssClasses_.ITEM), a = 0; a < n.length; a++)
        n[a].addEventListener('click', this.handleItemClick_.bind(this)),
          (n[a].tabIndex = '-1'),
          n[a].addEventListener('keydown', this.handleItemKeyboardEvent_.bind(this));
      if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT))
  ...
  (MaterialMenu.prototype.applyClip_ = function (e, t) {
    'use strict';
    this.element_.style.clip = this.element_.classList.contains(this.CssClasses_.UNALIGNED)
      ? null
      : this.element_.classList.contains(this.CssClasses_.BOTTOM_RIGHT)
      ? 'rect(0 ' + t + 'px 0 ' + t + 'px)'
      : this.element_.classList.contains(this.CssClasses_.TOP_LEFT)
  ...
  (MaterialTooltip.prototype.handleMouseEnter_ = function (e) {
    ...
    0 > s + i
      ...
      : ((this.element_.style.left = s + 'px'), (this.element_.style.marginLeft = i + 'px')),
  ...
  (MaterialTooltip.prototype.init = function () {
    ...
    if (this.element_) {
      ...
      e && (this.forElement_ = document.getElementById(e)),
        this.forElement_ &&
          (this.forElement_.getAttribute('tabindex') || this.forElement_.setAttribute('tabindex', '0'),
          (this.boundMouseEnterHandler = this.handleMouseEnter_.bind(this)),
          (this.boundMouseLeaveHandler = this.handleMouseLeave_.bind(this)),
          this.forElement_.addEventListener('mouseenter', this.boundMouseEnterHandler, !1),
          this.forElement_.addEventListener('click', this.boundMouseEnterHandler, !1),
          this.forElement_.addEventListener('blur', this.boundMouseLeaveHandler),
          this.forElement_.addEventListener('touchstart', this.boundMouseEnterHandler, !1),
  ...
  (MaterialTooltip.prototype.mdlDowngrade_ = function () {
    'use strict';
    this.forElement_ &&
      (this.forElement_.removeEventListener('mouseenter', this.boundMouseEnterHandler, !1),
      this.forElement_.removeEventListener('click', this.boundMouseEnterHandler, !1),
      this.forElement_.removeEventListener('touchstart', this.boundMouseEnterHandler, !1),
  ...
  (MaterialLayout.prototype.init = function () {
    ...
    if (this.element_) {
      ...
      for (var t = this.element_.childNodes, s = 0; s < t.length; s++) {
        var i = t[s];
        i.classList && i.classList.contains(this.CssClasses_.HEADER) && (this.header_ = i),
          i.classList && i.classList.contains(this.CssClasses_.DRAWER) && (this.drawer_ = i),
          i.classList && i.classList.contains(this.CssClasses_.CONTENT) && (this.content_ = i);
      }
        ...
        this.header_ &&
          (this.header_.classList.contains(this.CssClasses_.HEADER_SEAMED)
            ...
            : this.header_.classList.contains(this.CssClasses_.HEADER_SCROLL) &&
              ((n = this.Mode_.SCROLL), e.classList.add(this.CssClasses_.HAS_SCROLLING_HEADER)),
